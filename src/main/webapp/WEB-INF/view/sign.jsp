...
<head>
    ...
    <script>
        ...
        $(document).ready(function(){
            // 핸드폰 번호 입력시 자동으로 다음칸 이동
            $('#hp1').on("keyup",function(){  // 첫번째 010 입력후 2번째 칸으로 이동
            ...
            $('#hp2').on("keyup",function(){ // 가운데 4자리 입력후 3번째 칸으로 이동
                var mch = $(this).val().match(/[0-9]/g)
    ...
    <section>
        <div class="loginbox" style="top:90px;">
            <form action="/sign" method="post">
                ...
                <div class="input-box underline cf">
                    <input type="text" name="userEmail" id="userEmail" class="emailInput" placeholder="이메일*" required style="width:55%;">
                    <input type="submit" action="/sign/test.do" method="post" class="emailButton" value="이메일인증" style="width:45%; color: black; background-color: lightgray;">
                    <div class="underline"></div>
                </div>
                <div class="input-box">
                ...
                <div class="hp">
                    <input type="text" name="hp1" id="hp1" placeholder="010" required maxlength="3" style="width:33%; height: 40px; text-align: center; " oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                    <div class="underline"></div>
                    <input type="text" name="hp2" id="hp2"  placeholder="1234" required maxlength="4" style="width:33%; height: 40px; text-align: center;" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                    <div class="underline"></div>
                    <input type="text" name="hp3" id="hp3"  placeholder="5678" required maxlength="4" style="width:33%; height: 40px; text-align: center;" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                    <div class="underline"></div>
                </div>
                <script>
                ...
                <div class="input-box zipCode-inputBox cf" style="background-color: lightslategray;">
                    <input type="text" name="zipCode" id="zipCode" class="zipcode-input" placeholder="우편번호*" required style="width: 55%;">
                ...
                <div class="input-box">
                    <input type="text" name="address1" id="address1" onclick="DaumPostcode();" placeholder="주소*" required>
                    <div class="underline"></div>
                </div>
                <div class="input-box">
                ...
                <button type="submit" class="input-box button">회원가입</button>
            </form>
