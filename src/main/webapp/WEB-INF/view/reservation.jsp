...
<script>
    ...
    $(function(){
        ...
        /* 결제수단 - 무통장입금 안내 */
        $(".none_bankBookText").hide();
        if($("#creditCard").on('click',function(){
            $(".none_bankBookText").hide();
        }));
        if($("#none_bankBook").on('click',function(){
            $(".none_bankBookText").show();
        }));

        /*// n박의 n값을 input태그 hidden값으로 value에 넣음
        $('input[name=nightNum]').attr('value', Number($('.nightNum').html().split('박')[0]));*/
    ...
    var test = {
        paymentSend : function(e){
            ...
            // 예약번호(reservation_no) 히든값 (날짜 년/월/일 + 랜덤숫자 6자리) ex) 20230807123456
            // 그냥 new Date()만 하면 한국기준 UTC와 9시간 차이나므로 1일씩 차이가난다
            // 따라서 offset을 만들어서 현재시간에서 빼줘야 한국시간으로 나온다
            const date = new Date();
            const offset = date.getTimezoneOffset() * 60000; //ms단위라 60000곱해줌
            const dateOffset = new Date(date.getTime() - offset);
            $("input[name='reservation_no']").attr('value', dateOffset.toISOString().substring(0,10).replace(/-/g,'') + Math.random().toString().substring(2,8));
...
<form action="/payment" method="post" id="frm">
    ...
    <!-- 숙박일수 히든값 -->
    <input type="hidden" value="<c:out value='${nightNum}'></c:out>" name="nightNum">
<section>
    <div class="container">
        <div class="jss3">
            <div class="jss4">
                                    ...
                                    <div class="jss12">
                                        <div class="jss13" style="text-align: center;">
                                            <%--<div class="jss14"><c:out value="${roomVo.room_no}"></c:out> 호</div>--%>
                                                <div class="jss14">
                                                    <input type="text" name="room_no" id="room_no" class="box_none" value="<c:out value='${roomVo.room_no}'></c:out>" readonly style="width: 5%;">호
                                                </div>
            ...
            <div class="MuiGrid-root MuiGrid-container MuiGrid-spacing-xs-5">
                ...
                <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-sm-12 MuiGrid-grid-md-6">
                    <div>
                        ...
                        <div class="jss37">
                            <table class="MuiTable-root jss68">
                                <tbody>
                                <tr>
                    ...
                    <div>
                                    ...
                                    <td>
                                        <div class="MuiFormGroup-root MuiFormGroup-row" role="radiogroup"><div>
                                            <label class="MuiFormControlLabel-root">
                                                        <span class="MuiButtonBase-root MuiIconButton-root jss145 MuiRadio-root MuiRadio-colorPrimary MuiIconButton-colorPrimary" aria-disabled="false">
                                                            <span class="MuiIconButton-label">
                                                                <input class="jss148" type="radio" value="1" name="pay_type" id="creditCard"><!-- 신용카드 -->
                                                                <div class="jss149">
                                                                    <svg class="MuiSvgIcon-root" focusable="false" viewBox="0 0 24 24" aria-hidden="true" role="presentation">
                                        ...
                                        <div>
                                            <label class="MuiFormControlLabel-root">
                                                    <span class="MuiButtonBase-root MuiIconButton-root jss145 MuiRadio-root MuiRadio-colorPrimary MuiIconButton-colorPrimary" aria-disabled="false">
                                                        <span class="MuiIconButton-label">
                                                            <input class="jss148" type="radio" value="2" name="pay_type" id="none_bankBook"><!-- 무통장 -->
                                                            <div class="jss149">
                                                                <svg class="MuiSvgIcon-root" focusable="false" viewBox="0 0 24 24" aria-hidden="true" role="presentation">
                                                                    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"></path>
                                                                </svg>
                        ...
                        <div class="none_bankBook">
                            <textarea aria-invalid="false" rows="4" class="MuiInputBase-input MuiOutlinedInput-input MuiInputBase-inputMultiline MuiOutlinedInput-inputMultiline none_bankBookText" style="background-color: #f9f9f9; line-height: 25px; padding-top: 23px;" readonly>
                                국민은행 092-45-0590-999 김명호
                                예약하기 후 1시간안에 입금후 연락을 주셔야 예약이 확정됩니다.
                                그 이후에는 자동취소됩니다.
                            </textarea>
                        </div>
